...
if (APPLE)
    set(CMAKE_INSTALL_RPATH "@loaderpath")
    if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang" AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS 17)
        ...
        set(MAC_CXX_EXPERIMENTAL_PATH "/opt/local/libexec/llvm-${CLANG_VERSION_MAJOR}/lib" CACHE STRING "path of libc++experimental.a")
        ...
        set(CMAKE_INSTALL_RPATH "${CMAKE_INSTALL_RPATH};${MAC_CXX_EXPERIMENTAL_PATH}")
    endif ()
elseif (UNIX)
