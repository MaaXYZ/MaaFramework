...
class CallbackAgent:
    ...
    @MaaApiCallback
    def _c_callback(msg: ctypes.c_char_p, details_json: ctypes.c_char_p, callback_arg: ctypes.c_void_p):
        if not callback_arg:
            return
        ...
        self._callback(msg.decode('utf-8'), json.loads(details_json.decode('utf-8')), self._callback_arg)
