...
extern "C"
{
    ...
    MAA_FRAMEWORK_API MaaBool MaaResourceAddSink(MaaResource* res, MaaNotificationCallback notify, void* notify_trans_arg);

    MAA_FRAMEWORK_API MaaBool MaaResourceRemoveSink(MaaResource* res, MaaNotificationCallback notify);

    MAA_FRAMEWORK_API MaaBool MaaResourceClearSinks(MaaResource* res);
