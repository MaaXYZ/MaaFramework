...
- 零编码基础要求
- 通过 JSON 配置实现自动化流程
- 配套 [🎞️视频教程](https://www.bilibili.com/video/BV1yr421E7MW) 和 [⭐项目模板](https://github.com/MaaXYZ/MaaPracticeBoilerplate) （该视频教程使用的版本较老，部分内容可能过时。差异能容请以本仓库文档为准！）
- 结合 [MPE](https://github.com/kqcoxn/MaaPipelineEditor) 可视化编辑器进行拖拽式开发
