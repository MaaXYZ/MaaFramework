...
1. 自行整理资源并编写集成代码  
    ...
    更灵活，推荐对 MaaFW 有一定了解的开发者使用。

2. ⭐使用 [项目模板](https://github.com/MaaXYZ/MaaPracticeBoilerplate) 及通用 CLI  

    简单便捷，推荐新人使用。

## 准备资源文件

*⭐若您计划使用项目模板，直接在 [文件夹](https://github.com/MaaXYZ/MaaPracticeBoilerplate/tree/main/assets/resource/base) 中修改即可。*
