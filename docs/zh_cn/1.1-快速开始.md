...
* ⭐若您使用项目模板，请前往 [⭐项目模版仓库](https://github.com/MaaXYZ/MaaPracticeBoilerplate),仔细阅读文档与代码后，便可以开始快速开发。
* ⭐⭐注意：以下内容的阅读与实践的前置条件是您已经仔细阅读了以上[项目模版仓库](https://github.com/MaaXYZ/MaaPracticeBoilerplate)对应的文档跟代码。
...
## 准备资源文件
如果需要修改资源，请直接在 [项目模版的资源文件夹](https://github.com/MaaXYZ/MaaPracticeBoilerplate/tree/main/assets/resource) 下中修改即可。
