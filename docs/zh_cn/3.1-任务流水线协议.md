...
- `action`: *string*  
    ...
    可选的值：[`DoNothing`](#donothing) | [`Click`](#click) | [`LongPress`](#longpress) | [`Swipe`](#swipe) | [`MultiSwipe`](#swipe) | [`ClickKey`](#clickkey) | [`LongPressKey`](#longpress) | [`InputText`](#inputtext) | [`StartApp`](#startapp) | [`StopApp`](#stopapp) | [`StopTask`](#stoptask) | [`Command`](#command) | [`Custom`](#custom)  
    详见 [动作类型](#动作类型)。
