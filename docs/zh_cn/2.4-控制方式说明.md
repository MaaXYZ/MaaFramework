...
PlayCover 控制器用于在 macOS 上控制通过 [PlayCover](https://playcover.io/) 运行的 iOS 应用程序。
...
1. 在 macOS 上安装 [PlayCover](https://playcover.io/)
2. 目标 iOS 应用需要集成 [PlayTools](https://github.com/PlayCover/PlayTools) 并启用 MaaTools 功能
3. 应用需要监听指定端口（默认 1717）
