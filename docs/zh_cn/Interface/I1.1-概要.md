...
* controller `object[]`
  ...
  * adb `object`
    ...
    * input `number`
      ...
      可选. `Adb` 控制器的控制方式, 不提供则使用默认. 具体定义参见 [Input和Screencap](#input和screencap).

    * screencap `number`

      可选. `Adb` 控制器的截图方式, 不提供则使用默认. 具体定义参见 [Input和Screencap](#input和screencap).
  ...
  * win32 `object`
    ...
    * input `number`
      ...
      可选. `Win32` 控制器的控制方式, 不提供则使用默认. 具体定义参见 [Input和Screencap](#input和screencap).

    * screencap `number`

      可选. `Win32` 控制器的截图方式, 不提供则使用默认. 具体定义参见 [Input和Screencap](#input和screencap).
