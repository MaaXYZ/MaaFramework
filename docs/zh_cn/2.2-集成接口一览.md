...
注册名为 `name` 的自定义识别器 `recognition`。自定义识别器和自定义操作共享一个区分大小写的命名空间。若名称已被任一类型注册，则返回 `false` 且保留原注册；如需替换，应先移除原注册。
...
注册名为 `name` 的自定义操作 `action`。自定义识别器和自定义操作共享一个区分大小写的命名空间。若名称已被任一类型注册，则返回 `false` 且保留原注册；如需替换，应先移除原注册。
...
注册名为 `name` 的自定义识别器 `recognition`。自定义识别器和自定义操作共享一个区分大小写的命名空间。若名称已被任一类型注册，则返回 `false` 且保留原注册。
...
注册名为 `name` 的自定义操作 `action`。自定义识别器和自定义操作共享一个区分大小写的命名空间。若名称已被任一类型注册，则返回 `false` 且保留原注册。
