...
- `duration`: Scroll duration in ms
  - Adb Controller: swipe duration when simulating scroll with swipe
...
> Note: Minitouch/Maatouch/AdbShell input methods of Adb Controller do not support scroll operations.
> Win32 Controller uses mouse wheel events to implement scrolling.
