...
Connect. If startup, protocol validation, or custom registration fails, the client rolls back registrations made by the current attempt and tries to shut down the remote session, without tearing down the listening socket.
