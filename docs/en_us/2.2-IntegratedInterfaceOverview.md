...
Register a custom recognizer named `name`. Custom recognizers and custom actions share one case-sensitive namespace. If either type already uses the name, the function returns `false` and preserves the existing registration. Unregister the existing custom before replacing it.
...
Register a custom action named `name`. Custom recognizers and custom actions share one case-sensitive namespace. If either type already uses the name, the function returns `false` and preserves the existing registration. Unregister the existing custom before replacing it.
...
Register a custom recognizer named `name`. Custom recognizers and custom actions share one case-sensitive namespace. If either type already uses the name, the function returns `false` and preserves the existing registration.
...
Register a custom action named `name`. Custom recognizers and custom actions share one case-sensitive namespace. If either type already uses the name, the function returns `false` and preserves the existing registration.
