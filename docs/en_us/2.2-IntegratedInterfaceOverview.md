...
The Agent client will listen on 127.0.0.1 at the specified TCP port. The AgentServer can use the port number (e.g., `"12345"`) as the identifier to connect via TCP.
