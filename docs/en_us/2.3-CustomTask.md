...
```shell
/path/to/my_recognizer.exe  custom_arg_1  custom_arg_2  ...  sync_context  image_path  task_name  custom_recognizer_param
```
...
- `custom_recognizer_param`  

  The value of `custom_recognizer_param` defined in the pipeline JSON.
