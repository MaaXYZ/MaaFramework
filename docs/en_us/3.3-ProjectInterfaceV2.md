...
* **controller** `object[]`  
  ...
  * **icon** `string`  
  ...
  - **gamepad** `object`  
    ...
    - **class_regex** `string`  
      _Optional._ The regular expression used to search for window class names for screenshot functionality. If not provided, screenshot is disabled.

    - **window_regex** `string`  
      _Optional._ The regular expression used to search for window titles for screenshot functionality. If not provided, screenshot is disabled.
