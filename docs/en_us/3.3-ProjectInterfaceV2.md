...
* **controller** `object[]`
  ...
  * **playcover** `object`
    ...
    * **address** `string`
      _Optional._ The default address of the PlayTools service, in the format `host:port`, e.g., `127.0.0.1:1717`.

    * **uuid** `string`
      _Optional._ The default Bundle Identifier of the target application, e.g., `com.bilibili.trickcalcn`.
