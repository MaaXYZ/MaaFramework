...
| 2026-09-08 | v2.10.2 | Added string arrays to `welcome` |
...
- **welcome** `string | string[]` **💡 v2.10.2**  
  ...
  Starting with v2.10.2, a string array can declare multiple announcements, which the Client must display in array order. The array must not be empty.  
