...
* **controller** `object[]`
  ...
  * **playcover** `object`
    ...
    * **uuid** `string`
      _Optional._ The default Bundle Identifier of the target application, such as `com.bilibili.trickcalcn`, is used only as a controller identifier and is unrelated to the application being controlled.
