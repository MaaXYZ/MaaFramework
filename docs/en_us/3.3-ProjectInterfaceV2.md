...
* **resource** `object[]`
  ...
  * **option** `string[]`_Optional._ Global option configuration for the resource package, an array of strings. Array elements should correspond to the key names in the outer `option` configuration. The parameters generated by this option will participate in the pipeline override of all tasks, serving as global parameter passing.
