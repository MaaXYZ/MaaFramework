...
Due to the rapid iteration of business development, the release schedule of MaaFramework is not entirely synchronized with the iteration schedule of PI. Therefore, PI will have its own separate version control, and its version number will not be completely synchronized with the MaaFramework release version number.
