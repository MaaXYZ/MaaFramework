...
You can choose between two development options:

1. Organize resources and write integration code yourself

    More flexible, recommended for developers who have a certain understanding of MaaFW.

2. ⭐Use [Project Template](https://github.com/MaaXYZ/MaaPracticeBoilerplate) and general CLI

    Simple and convenient, recommended for new developers.

## Prepare resource files

*⭐If you plan to use the project template, just modify it directly in [folder](https://github.com/MaaXYZ/MaaPracticeBoilerplate/tree/main/assets/resource/base).*
