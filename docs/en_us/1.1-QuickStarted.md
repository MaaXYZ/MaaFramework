...
The official [MaaPiCli](3.3-ProjectInterfaceV2.md) command-line client is distributed separately as `MAA-PiCli-<os>-<arch>` in Releases. It is no longer bundled with the `MAA-*` packages.
