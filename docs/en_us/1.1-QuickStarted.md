...
If you need to modify resources, you can directly make changes in the [Folder](https://github.com/MaaXYZ/MaaPracticeBoilerplate/tree/main/assets/resource).* Modify Resources
