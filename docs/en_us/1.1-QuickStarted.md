...
- Comes with a [🎞️ video tutorial](https://www.bilibili.com/video/BV1yr421E7MW) and a [⭐ project template](https://github.com/MaaXYZ/MaaPracticeBoilerplate) (The video tutorial uses an older version and some of the content may be outdated. Please refer to the documents of this repository for the difference!)
- Combine drag-and-drop development with the [MPE](https://github.com/kqcoxn/MaaPipelineEditor) visual editor.
