...
- Registers custom task modules through the Agent
...
💡 The General UI will automatically connect to your Agent process and call the corresponding recognition/action when executing `MyReco`/`MyAct`.
