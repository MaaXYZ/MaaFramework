...
* ⭐ If you are using a project template, please go to the [⭐ Project Template Repository](https://github.com/MaaXYZ/MaaPracticeBoilerplate). After carefully reading the documentation and code, you can start rapid development.

* ⭐⭐ Note: The prerequisite for reading and practicing the following content is that you have carefully read the documentation and code corresponding to the above [Project Template Repository](https://github.com/MaaXYZ/MaaPracticeBoilerplate).
```jsonc
...
*If you need to modify resources, you can directly make changes in the [Project Template Folder](https://github.com/MaaXYZ/MaaPracticeBoilerplate/tree/main/assets/resource).* 
