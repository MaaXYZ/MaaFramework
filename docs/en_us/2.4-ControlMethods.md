...
The KWin controller is used in the Linux Wayland (KWin) desktop environment to implement screen capturing and input injection via PipeWire and `/dev/uinput`.
