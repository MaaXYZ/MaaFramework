...
The KWin controller is used to implement screen capturing and input injection via PipeWire and `/dev/uinput`. It is still called the "KWin controller" because it was originally developed and tested primarily on the KWin compositor, and the name has been retained since.
