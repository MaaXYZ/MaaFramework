...
The PlayCover controller is used to control iOS applications running via [PlayCover](https://playcover.io/) on macOS.
...
1. Install [PlayCover](https://playcover.io/) on macOS
2. Target iOS app must integrate [PlayTools](https://github.com/PlayCover/PlayTools) with MaaTools feature enabled
3. App must listen on the specified port (default 1717)
