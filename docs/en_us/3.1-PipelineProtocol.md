...
- `action`: *string*  
    ...
    Possible values: [`DoNothing`](#donothing) | [`Click`](#click) | [`LongPress`](#longpress) | [`Swipe`](#swipe) | [`MultiSwipe`](#multiswipe) | [`Scroll`](#scroll) | [`ClickKey`](#clickkey) | [`LongPressKey`](#longpresskey) | [`InputText`](#inputtext) | [`StartApp`](#startapp) | [`StopApp`](#stopapp) | [`Shell`](#shell) | [`StopTask`](#stoptask) | [`Command`](#command) | [`Custom`](#custom-1)  
...
> Note: This action is only valid for ADB controllers. The command output is logged but not stored in pipeline context. For commands where you need to capture output, use the C API `MaaControllerPostShell` instead.
