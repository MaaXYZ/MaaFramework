...
- `roi`: *array<int, 4>* | *string*  
  ...
  - *string*: Fill in the node name, and identify within the target range identified by a previously executed node. Also supports `[Anchor]AnchorName` format to reference the node corresponding to an anchor.
...
- `target`: *true* | *string* | *array<int, 2>* | *array<int, 4>*  
  ...
  - *string*: Enter the node name, as the target, to use the position recognized by a previously executed node. Also supports `[Anchor]AnchorName` format to reference the node corresponding to an anchor.
...
- `target`: *true* | *string* | *array<int, 2>* | *array<int, 4>* **💡 v5.5**  
  ...
  - *string*: Fill in a node name; the target is the position recognized by a previously executed node. Also supports `[Anchor]AnchorName` format to reference the node corresponding to an anchor.  
