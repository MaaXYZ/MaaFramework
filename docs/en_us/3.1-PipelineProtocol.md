...
Within the Android device's system settings interface, the following operations need to be completed:

- Locate and enter the "Storage" feature module;
- Within the "Storage" interface, scroll down to locate and enter the "Games" entry at the bottom.
...
1. Start **Example**
2. Recognize **Open_Games** -> Failure
3. Recognize **Open_Storage** -> Success -> Execute click operation
4. Return to the `next` and `interrupt` lists of **Example**.
5. Recognize **Open_Games** -> Failure
6. Recognize **Open_Storage** -> Failure
7. Execute **Swipe** action.
8. Return to the `next` and `interrupt` lists of **Example**.
9. Recognize **Open_Games** -> Success -> Execute click operation
10. The `next` list of "Open_Games" is empty → Task completed.

#### Special Case (Task Initiated Inside "Storage" Interface)

1. Start **Example**
2. Recognize **Open_Games** -> Failure
3. Recognize **Open_Storage** -> Failure
4. Execute **Swipe** action.
5. Return to the `next` and `interrupt` lists of **Example**.
6. Recognize **Open_Games** -> Success -> Execute click operation
7. The `next` list of "Open_Games" is empty → Task completed.
