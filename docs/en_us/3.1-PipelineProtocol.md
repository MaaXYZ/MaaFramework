...
- `timeout`: *uint*  
    Timeout for recognizing nodes, in milliseconds. Timing starts after `post_delay`. Optional, default is 20 * 1000 milliseconds (20 seconds).  
