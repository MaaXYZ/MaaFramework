...
- `contact`: *uint*  
    Contact id used to distinguish different touch points. Optional, default `0`.  
  - Adb Controller: Finger id (0 for first finger, 1 for second finger, etc., maximum cannot exceed 10)
  - Win32 Controller: Mouse button id (0 for left, 1 for right, 2 for middle, 3 for XBUTTON1, 4 for XBUTTON2)
...
- `swipes`: *list<object,>*  
  ...
  - `contact`: *uint*  
      Contact id used to distinguish different touch points. Optional, defaults to using the index of the swipe in the array as the contact id (starting from 0).  
    - Adb Controller: Finger id (0 for first finger, 1 for second finger, etc., maximum cannot exceed 10)
    - Win32 Controller: Mouse button id (0 for left, 1 for right, 2 for middle, 3 for XBUTTON1, 4 for XBUTTON2)
