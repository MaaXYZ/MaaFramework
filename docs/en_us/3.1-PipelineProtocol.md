...
1. Recognize **Click_Storage** -> Success -> Execute click action
2. Jump to the `next` list of **Click_Storage**
3. No recognition performed -> directly execute **Scroll_Down** action
4. Jump to the `next` list of **Swipe**
5. Recognize **Click_Game** -> Success -> Execute click action
6. `next` list of **Click Game** is empty, task completed
