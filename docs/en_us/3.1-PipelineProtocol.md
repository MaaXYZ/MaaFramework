...
- `timeout`: *uint*  
    Timeout for recognizing, which starts counting before the first recognition, in milliseconds. Optional, default is 20 * 1000 milliseconds (20 seconds).  
