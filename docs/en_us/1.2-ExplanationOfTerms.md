...
- **UI**  
    ...
    In the MaaFW project, it usually refers to the `generic UI`. The UI builds configuration items from `interface.json`, then passes resource files to the MaaFW core as needed.
