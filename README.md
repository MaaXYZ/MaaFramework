...
MAA 正计划建设为一类项目，而非舟的单一软件。只要您的项目依赖于 MaaFramework，我们欢迎您将它命名为 MaaXXX, MXA, MAX 等等。当然这是许可而不是限制，您也可以自由选择其他与 MAA 无关的名字，完全取决于您自己的想法！  
同时，也非常欢迎您向本仓库提交 PR，在上方的最佳实践列表中添加上您的项目！
