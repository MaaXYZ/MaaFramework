...
void UnitBase::set_replacement(Replacemenet argv_replace)
{
...
void UnitBase::merge_replacement(Replacemenet argv_replace, bool _override)
{
    for (auto child : children_) {
