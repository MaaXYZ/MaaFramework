...
Win32IO::Win32IO(IPlatformRelatedInstanceInfo* p) : infoProvider(p)
{
    LogTraceFunction;
                                               ...
                                               std::chrono::steady_clock::time_point start_time)
{
    ...
    if (!MAA_PLATFORM_NS::win32::CreateOverlappablePipe(&pipe_parent_read, &pipe_child_write, nullptr, &sa_inherit,
...
std::optional<unsigned short> Win32IO::init_socket(const std::string& local_address)
{
    LogTraceFunction;
...
std::shared_ptr<IOHandler> Win32IO::interactive_shell(const ArgVInst& cmd)
{
    ...
    if (!MAA_PLATFORM_NS::win32::CreateOverlappablePipe(&pipe_parent_read, &pipe_child_write, nullptr, &sa_attr_inherit,
                                             PipeReadBuffSize, true, false) ||
        !MAA_PLATFORM_NS::win32::CreateOverlappablePipe(&pipe_child_read, &pipe_parent_write, &sa_attr_inherit, nullptr,
