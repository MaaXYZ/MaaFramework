...
private:
    static std::optional<Record>
        parse_record(const json::value& record_json, const std::filesystem::path& dir);
    ...
    static std::optional<Record::Param>
        parse_screencap(const json::value& record_json, const std::filesystem::path& dir);
