...
Status DeviceImpl::find(
    ServerContext* context, const ::maarpc::EmptyRequest* request, ::maarpc::DeviceInfosResponse* response)
{
    LogFunc;
    std::ignore = context;
    std::ignore = request;
...
Status DeviceImpl::find_with_adb(
    ServerContext* context, const ::maarpc::StringRequest* request, ::maarpc::DeviceInfosResponse* response)
{
    LogFunc;
    std::ignore = context;
