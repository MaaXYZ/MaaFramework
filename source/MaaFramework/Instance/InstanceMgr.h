...
public: // from MaaInstanceAPI
    ...
    virtual bool register_custom_recognizer(
        std::string name, MaaCustomRecognizerHandle handle, MaaTransparentArg handle_arg) override;
    virtual bool unregister_custom_recognizer(std::string name) override;
    virtual void clear_custom_recognizer() override;
    virtual bool
        register_custom_action(std::string name, MaaCustomActionHandle handle, MaaTransparentArg handle_arg) override;
