...
private:
    ...
    winrt::Windows::Graphics::Capture::GraphicsCaptureItem cap_item_;
    winrt::Windows::Graphics::Capture::Direct3D11CaptureFramePool cap_frame_pool_;
    winrt::Windows::Graphics::Capture::GraphicsCaptureSession cap_session_;
};
